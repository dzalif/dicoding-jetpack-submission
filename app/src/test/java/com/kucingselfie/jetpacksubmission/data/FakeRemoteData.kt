package com.kucingselfie.jetpacksubmission.data
...
object FakeRemoteData {
    fun getDummyMovies() : List<Movie> {
        ...
        movies.add(
            Movie(
                ...
                "/dCB7d4l0mfpsISZvr6aPE2z5QF6.jpg",
        ...
        movies.add(
            Movie(
                651693,
                "My Bakit List",
                "/jVr8vyatgZsPh2Po3W0IoLnMSJl.jpg",
        ...
        movies.add(
            Movie(
                449924,
                "Ip Man 4: The Finale",
                "/jMmi8lUMNW18ugr38uaEEg6LgJK.jpg",
    ...
    fun getDummyTVShows() : List<TVShow> {
        ...
        tvShows.add(
            TVShow(
                71912,
                "The Witcher",
                "/zrPpUlehQaBf8YX2NrVrKK8IEpf.jpg",
    ...
    fun getMovieDetail() : DetailModel {
        return DetailModel(
            181812,
            "Star Wars: The Rise of Skywalker",
            "The surviving Resistance faces the First Order once again as the journey of Rey, Finn and Poe Dameron continues. With the power and knowledge of generations behind them, the final battle begins.",
    ...
    fun getTvshowDetail() : DetailTvShowModel {
